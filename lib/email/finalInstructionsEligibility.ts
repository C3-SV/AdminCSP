...
export function getFinalInstructionsEligibilityError(registration: Pick<RegistrationDocument, "category" | "estadoCompetitivo" | "laboratorioAsignado">) {
  if (registration.category === "desconocida" || !getFinalInstructionsConfig(registration.category)) return "Las indicaciones finales están disponibles sólo para Colegios y Universidades.";
