...
export const ONSITE_CLASSIFICATION_SUBJECT = "¡Clasificaron a la final presencial de la Copa Salvadoreña de Programación 2026!";
...
export function buildOnsiteClassificationContent(registration: RegistrationDocument) {
  ...
  return {
    subject: ONSITE_CLASSIFICATION_SUBJECT,
