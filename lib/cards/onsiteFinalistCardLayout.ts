...
export const ONSITE_FINALIST_STORY_WIDTH = 1080;
export const ONSITE_FINALIST_STORY_HEIGHT = 1920;
...
const boxes = {
  ...
  institution: { x: 150, y: 684, width: 780, height: 72, maxFontSize: 38, minFontSize: 19, maxLines: 2 },
...
const storyBoxes = {
  teamName: { x: 135, y: 810, width: 810, height: 155, maxFontSize: 66, minFontSize: 28, maxLines: 2 },
  institution: { x: 150, y: 1080, width: 780, height: 68, maxFontSize: 38, minFontSize: 19, maxLines: 2 },
  member1: { x: 150, y: 1224, width: 780, height: 46, maxFontSize: 37, minFontSize: 19, maxLines: 1 },
  member2: { x: 150, y: 1276, width: 780, height: 46, maxFontSize: 37, minFontSize: 19, maxLines: 1 },
  member3: { x: 150, y: 1328, width: 780, height: 46, maxFontSize: 37, minFontSize: 19, maxLines: 1 },
} satisfies OnsiteFinalistCardConfig["boxes"];
...
export const ONSITE_FINALIST_STORY_CONFIG: Record<KnownRegistrationCategory, OnsiteFinalistCardConfig> = {
  colegios: { template: "colegios", categoryLabel: "Colegios", finalDate: SCHOOL_PRESENTIAL_DATE, boxes: storyBoxes },
  universidades: { template: "universidades", categoryLabel: "Universidades", finalDate: UNIVERSITY_PRESENTIAL_DATE, boxes: storyBoxes },
  ade: { template: "ade", categoryLabel: "AdE", finalDate: ADE_PRESENTIAL_DATE, boxes: storyBoxes },
};
...
export function getOnsiteFinalistStoryFileName(teamName: string) {
  const safeTeam = teamName.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-zA-Z0-9]+/g, "-").replace(/(^-|-$)/g, "").slice(0, 60) || "equipo";
  return `CSP-2026-final-presencial-historia-${safeTeam}.png`;
}
